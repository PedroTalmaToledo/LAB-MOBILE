...
public class RotaResponse {
    ...
    public List<Coordenada> getRota() { return rota; }

    public void setDistanciaKm(double distanciaKm) { this.distanciaKm = distanciaKm; }
    public void setDuracaoHoras(String duracaoHoras) { this.duracaoHoras = duracaoHoras; }
    public void setRota(List<Coordenada> rota) { this.rota = rota; }
}
